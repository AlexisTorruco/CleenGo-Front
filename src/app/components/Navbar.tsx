        ...
        >
          ...
          {!user && (
            <div className="flex flex-col lg:flex-row lg:items-center lg:gap-6 gap-3 w-full">
              ...
              <Link href="/subscriptions" onClick={handleMenuItemClick} className="text-gray-700 font-medium hover:text-teal-500 transition">Suscripción</Link>
              <Link href="/blog" onClick={handleMenuItemClick} className="text-gray-700 font-medium hover:text-teal-500 transition">Blog</Link>
              <Link href="/login" onClick={handleMenuItemClick} className="bg-teal-500 text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-teal-600 transition shadow-sm text-center">Iniciar Sesión</Link>
            </div>
          )}
          ...
          {user && role === 'client' && (
            <div className="flex flex-col lg:flex-row lg:items-center lg:gap-6 gap-3 w-full">
              ...
              <Link href="/client/profile" onClick={handleMenuItemClick} className="text-gray-700 hover:text-teal-500 transition">
          ...
          {user && role === 'provider' && (
            <div className="flex flex-col lg:flex-row lg:items-center lg:gap-6 gap-3 w-full">
              ...
              <Link href="/provider/appointments" onClick={handleMenuItemClick} className="text-gray-700 hover:text-teal-500 transition">
                <svg className="w-6 h-6 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
